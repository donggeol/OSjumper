...
public class AudioReader
{
	...
	public AudioReader()
	{
		int audioBuf = AudioRecord.getMinBufferSize(8000, AudioFormat.CHANNEL_CONFIGURATION_MONO, AudioFormat.ENCODING_PCM_16BIT) * 2;
		audioInput = new AudioRecord(MediaRecorder.AudioSource.MIC, 8000, AudioFormat.CHANNEL_CONFIGURATION_MONO, AudioFormat.ENCODING_PCM_16BIT, audioBuf);
		//audioInput = new AudioRecord(6, 8000, 16, 2, Math.max(AudioRecord.getMinBufferSize(8000, 16, 2), 1024 * 10)); // 1024 * 10
	}
