...
{
    QMessageBox::question(this, "a", "void ScreenSettingsDialog::on_m_pButtonAddAlias_clicked()",
...
{
    QMessageBox::question(this, "a", "void ScreenSettingsDialog::on_m_pLineEditAlias_textChanged(const QString& text)",
                                           QMessageBox::Yes|QMessageBox::No);
...
{
    QMessageBox::question(this, "a", "void ScreenSettingsDialog::on_m_pButtonRemoveAlias_clicked()",
                                           QMessageBox::Yes|QMessageBox::No);
...
{
    QMessageBox::question(this, "a", "void ScreenSettingsDialog::on_m_pListAliases_itemSelectionChanged()",
                                           QMessageBox::Yes|QMessageBox::No);
