...
public class EndpointerInputStream extends InputStream implements AsyncClosableInputStream 
{
	...
	private byte[] mBuf = new byte[1600];
	...
	private int judgeNoise(byte[] data, int offset, int length) throws IOException 
	{
